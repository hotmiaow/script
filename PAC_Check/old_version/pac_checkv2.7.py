...
def workflow_setup_baseline():
    ...
    print("    - old_test_logic.csv              (logic test cases from old PAC)")
    print("    - old_test_reachability.csv       (reachability test cases from old PAC)")
...
def workflow_test_and_compare():
    ...
    print("    - updated_test_logic.csv                    (logic test cases from updated PAC)")
    print("    - updated_test_reachability.csv             (reachability test cases from updated PAC)")
