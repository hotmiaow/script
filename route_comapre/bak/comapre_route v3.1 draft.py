                ...
                if in_file1 and in_file2:
                    ...
                    if valid_cov:
                        ...
                        for cov_subnet, before_info, after_info in valid_cov[:3]:
                            protos = sorted(list(set(
                                [p[0] for p in before_info if p and p] +
                                [p for p in after_info if p and p]
                            )))
                        ...
                        if invalid_cov:
                            ...
                            for item in invalid_cov[:3]:
                                ...
                                if not (item['in_before'] and item['in_after']):
                                    ...
                                    reasons.append(f"{cov} NH mismatch (before={item['before_nexthops']}, after={item['after_nexthops']})")
