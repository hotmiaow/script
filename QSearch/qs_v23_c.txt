...
class SearchEngine:
    ...
    def _parse_boolean_query_sql(self, query_str: str) -> Tuple[Optional[str], Tuple[Optional[str], List[Any]], List[str]]:
        ...
        for or_branch in or_parts:
            # Tokenize while keeping "quoted phrases" intact as a single
            # atomic term instead of splitting them on internal whitespace
            # (otherwise "link down" degrades into an unordered AND of the
            # individual words instead of a verbatim phrase match).
