...
def export_csv(results, filepath, mode='both'):
    ...
    headers = ["FQDN", "GTM Pool", "GTM Member", "LTM VS", "VS Dest", "SNAT", "iRules", "Profiles", "LTM Pool", "LTM Member"]
                    ...
                    if members:
                        for member in members:
                            writer.writerow([
                                ...
                                r['vs_dest'], r.get('snat', '-'), irules_str, profiles_str, r['ltm_pool'], member
                            ])
                    else:
                        writer.writerow([
                            r['fqdn'], r['gtm_pool'], r['gtm_member'], r['ltm_vs'], 
                            r['vs_dest'], r.get('snat', '-'), irules_str, profiles_str, r['ltm_pool'], '-'
                        ])
